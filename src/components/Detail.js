...
export default function Detail({ title, desc, img, color }) {
  return (
    <div className="flex flex-col md:flex-row items-center md:justify-center md:gap-x-20 gap-y-10 py-32 px-5 sm:px-10 ">
      <img src={img} alt={img} className="min-w-[250px] max-w-[300px]" />
      <div className="content max-w-[430px] md:max-w-[700px] ">
        ...
        <div className="body mt-7">
          <p className="text-xl sm:text-2xl text-center md:text-left">{desc}</p>
        </div>
      </div>
    </div>
  )
